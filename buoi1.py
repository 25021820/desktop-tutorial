...
Original file is located at
    https://colab.research.google.com/drive/15KwYa876ZMRVUEmMA6cG7Zfz47QsvmpJ
"""
...
#W2A9
x = float(input("Nhập giá chiếc đồng hồ (USD): "))
tong_tien = x * 1.4 + 10
print("Tổng số tiền phải trả:", round(tong_tien, 2), "USD")
